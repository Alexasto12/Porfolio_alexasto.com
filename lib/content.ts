...
export const DATA = {
  ...
  neibr: {
    ...
    tags: ["GO · CHI ROUTER", "API-FIRST", "MULTI-TENANT", "B2B + APP", "ES · CA · EN"],
  ...
  approach: {
    ...
    principles: [
      { index: "01", title: l("Diseño primero la API.", "API design comes first.", "Dissenyo primer l'API."),
        body: l("Antes de escribir lógica de negocio, defino contratos. La forma de los datos predice la forma del producto. OpenAPI versionado, ejemplos canónicos y tests de contrato antes que código.",
      ...
      { index: "02", title: l("Mido lo que se mueve.", "Measure what moves.", "Mesuro el que es mou."),
        body: l("Métricas, trazas y logs estructurados desde el día uno. Sin observabilidad, optimizar es adivinar. Cada microservicio expone /metrics y un dashboard mínimo con p50/p99 y tasa de error.",
      ...
      { index: "03", title: l("Construyo para fallos.", "Build for failure.", "Construeixo per als errors."),
        body: l("Timeouts, retries con jitter, circuit breakers y degradación elegante. El happy path es la excepción, no la regla. Cuando algo cae, el sistema se contrae sin tirar al resto.",
      ...
      { index: "04", title: l("Documento como código.", "Docs as code.", "Documento com a codi."),
        body: l("OpenAPI versionado, ADRs cortos para decisiones de arquitectura y READMEs que un nuevo integrante pueda ejecutar en una tarde. La documentación vive en el mismo repo que el código.",
  ...
  vmv: {
    ...
    capabilities: [
      { title: l("Cuentas, dominios e infraestructura.", "Accounts, domains & infrastructure.", "Comptes, dominis i infraestructura."),
        description: l("Alta y gestión de cuentas corporativas, registros DNS, correo, certificados, hosting y despliegues. La capa que rara vez se ve y que sostiene todo lo demás.",
  ...
  timeline: {
    ...
    entries: [
      ...
      { year: "16", age: l("años · técnico", "y/o · technician", "anys · tècnic"), kind: "work",
        title: l("Arreglo PCs y monto instalaciones desatendidas.", "Fixing PCs and building unattended installs.", "Arreglo PCs i munto instal·lacions desateses."),
        place: l("pequeño negocio · particulares", "small business · individuals", "petit negoci · particulars"),
        body: l("Servicio técnico real. Imágenes de Windows desatendidas, scripts de post-install, drivers, despliegues por lote. Aquí aprendí que la repetibilidad es lo que separa al técnico del improvisador.",
      ...
      { year: "19", age: l("años · soporte móvil", "y/o · mobile support", "anys · suport mòbil"), kind: "work",
        title: l("Soporte técnico de telefonía móvil.", "Mobile-phone technical support.", "Suport tècnic de telefonia mòbil."),
        place: l("primer empleo formal", "first formal job", "primera feina formal"),
        body: l("Atención a usuarios, diagnóstico, escalado y reparación a nivel componente. El año de aprender a explicar cosas complicadas a quien las necesita sin la jerga.",
      ...
      { year: "21", age: l("años · helpdesk", "y/o · helpdesk", "anys · helpdesk"), kind: "work",
        title: l("Trabajo de helpdesk corporativo.", "Corporate helpdesk role.", "Treball d'helpdesk corporatiu."),
        place: l("empresa · soporte L1/L2", "enterprise · L1/L2 support", "empresa · suport L1/L2"),
        body: l("Primer contacto con la operación a escala: tickets, SLA, runbooks y la diferencia real entre L1 y L2. Empiezo a leer código para entender los problemas que escalan.",
      ...
      { year: "22", age: l("años · primera línea de código", "y/o · first line of code", "anys · primera línia de codi"), kind: "education",
        title: l("Comienzo a programar en serio.", "Start programming for real.", "Començo a programar de debò."),
        place: l("formación + autodidacta", "formal + self-taught", "formació + autodidacta"),
        body: l("Cierro el ciclo del helpdesk y empiezo formación formal en desarrollo web. Stack base: HTML, CSS, JavaScript, PHP, Laravel, Angular, MySQL. El reflejo de programar todos los días.",
  ...
  academic: {
    ...
    projects: [
      { id: "peer2stream", name: "peer2stream", sub: l("TFG · 10/10", "FYP · 10/10", "TFG · 10/10"), dim: "1440×900",
        ...
        links: [{ label: "github.com/Alexasto12/peer2stream ↗", href: "https://github.com/Alexasto12/peer2stream" }],
